        ...
        if st.session_state.get('show_admin') and is_admin:
            ...
            try:
                ...
                if status:
                    ...
                    # Wrap all FAQ buttons in a single flexbox container
                    st.sidebar.markdown('<div class="faq-buttons-wrapper">', unsafe_allow_html=True)
                    
                    # Create FAQ buttons with uniform width and tight spacing
